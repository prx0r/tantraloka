#!/usr/bin/env python3
"""PLATINUM PACK -- The Black Iron Prison"""
...
OUTPUT = Path("/mnt/HC_Volume_106427611/goldrender/output_pkd_exegesis")
...
def v_2_3_74_the_trigger(im, u, t, p):
    ...
    seal(im,"2-3-74 The Trigger","VALIS and 2-3-74")

def v_the_fish_necklace(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Fish Necklace","VALIS and 2-3-74")

def v_the_pink_beam(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Pink Beam","VALIS and 2-3-74")

def v_the_black_iron_priso(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Black Iron Prison","VALIS and 2-3-74")

def v_the_empire_never_end(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Empire Never Ended","VALIS and 2-3-74")

def v_valis(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"VALIS","VALIS and 2-3-74")

def v_holographic_informat(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Holographic Information","VALIS and 2-3-74")

def v_st_sophia_and_the_th(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"St. Sophia and the Theotropic","VALIS and 2-3-74")

def v_supreme_counter_inte(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Supreme Counter-Intelligence","VALIS and 2-3-74")

def v_time_is_a_lie(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Time is a Lie","VALIS and 2-3-74")

def v_competing_timelines(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Competing Timelines","VALIS and 2-3-74")

def v_garden_vs_empire(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Garden vs Empire","VALIS and 2-3-74")

VISUALS = {
    "2_3_74_the_trigger": v_2_3_74_the_trigger,
    "the_fish_necklace": v_the_fish_necklace,
    "the_pink_beam": v_the_pink_beam,
    "the_black_iron_priso": v_the_black_iron_priso,
    "the_empire_never_end": v_the_empire_never_end,
    "valis": v_valis,
    "holographic_informat": v_holographic_informat,
    "st_sophia_and_the_th": v_st_sophia_and_the_th,
    "supreme_counter_inte": v_supreme_counter_inte,
    "time_is_a_lie": v_time_is_a_lie,
    "competing_timelines": v_competing_timelines,
    "garden_vs_empire": v_garden_vs_empire,
}
...
SCENES = [
    Scene("2-3-74 The Trigger", "VALIS and 2-3-74", 7.0, "2_3_74_the_trigger", {}),
    Scene("The Fish Necklace", "VALIS and 2-3-74", 7.0, "the_fish_necklace", {}),
    Scene("The Pink Beam", "VALIS and 2-3-74", 7.0, "the_pink_beam", {}),
    Scene("The Black Iron Prison", "VALIS and 2-3-74", 7.0, "the_black_iron_priso", {}),
    Scene("The Empire Never Ended", "VALIS and 2-3-74", 7.0, "the_empire_never_end", {}),
    Scene("VALIS", "VALIS and 2-3-74", 7.0, "valis", {}),
    Scene("Holographic Information", "VALIS and 2-3-74", 7.0, "holographic_informat", {}),
    Scene("St. Sophia and the Theotropic", "VALIS and 2-3-74", 7.0, "st_sophia_and_the_th", {}),
    Scene("Supreme Counter-Intelligence", "VALIS and 2-3-74", 7.0, "supreme_counter_inte", {}),
    Scene("Time is a Lie", "VALIS and 2-3-74", 7.0, "time_is_a_lie", {}),
    Scene("Competing Timelines", "VALIS and 2-3-74", 7.0, "competing_timelines", {}),
    Scene("Garden vs Empire", "VALIS and 2-3-74", 7.0, "garden_vs_empire", {}),
]
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"The Black Iron Prison","scene_count":len(SCENES),
        "runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],
        "continuity_object":"SUBThe Black Iron Prison",
        "palette_roles":{"ink":"prison","gold":"VALIS","crimson":"empire"},"scenes":recs},
