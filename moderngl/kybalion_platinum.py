#!/usr/bin/env python3
"""PLATINUM PACK -- The Seven Hermetic Principles"""
...
OUTPUT = Path("/mnt/HC_Volume_106427611/goldrender/output_kybalion")
...
def v_the_principle_of_men(im, u, t, p):
    ...
    seal(im,"The Principle of Mentalism","laws of reality")

def v_the_principle_of_cor(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Principle of Correspondence","laws of reality")

def v_the_principle_of_vib(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Principle of Vibration","laws of reality")

def v_the_principle_of_pol(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Principle of Polarity","laws of reality")

def v_the_principle_of_rhy(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Principle of Rhythm","laws of reality")

def v_the_principle_of_cau(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Principle of Cause and Effect","laws of reality")

def v_the_principle_of_gen(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Principle of Gender","laws of reality")

def v_the_universe_is_ment(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Universe is Mental","laws of reality")

def v_everything_is_double(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Everything is Double","laws of reality")

def v_mastery(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Mastery","laws of reality")

VISUALS = {
    "the_principle_of_men": v_the_principle_of_men,
    "the_principle_of_cor": v_the_principle_of_cor,
    "the_principle_of_vib": v_the_principle_of_vib,
    "the_principle_of_pol": v_the_principle_of_pol,
    "the_principle_of_rhy": v_the_principle_of_rhy,
    "the_principle_of_cau": v_the_principle_of_cau,
    "the_principle_of_gen": v_the_principle_of_gen,
    "the_universe_is_ment": v_the_universe_is_ment,
    "everything_is_double": v_everything_is_double,
    "mastery": v_mastery,
}
...
SCENES = [
    Scene("The Principle of Mentalism", "laws of reality", 7.0, "the_principle_of_men", {}),
    Scene("The Principle of Correspondence", "laws of reality", 7.0, "the_principle_of_cor", {}),
    Scene("The Principle of Vibration", "laws of reality", 7.0, "the_principle_of_vib", {}),
    Scene("The Principle of Polarity", "laws of reality", 7.0, "the_principle_of_pol", {}),
    Scene("The Principle of Rhythm", "laws of reality", 7.0, "the_principle_of_rhy", {}),
    Scene("The Principle of Cause and Effect", "laws of reality", 7.0, "the_principle_of_cau", {}),
    Scene("The Principle of Gender", "laws of reality", 7.0, "the_principle_of_gen", {}),
    Scene("The Universe is Mental", "laws of reality", 7.0, "the_universe_is_ment", {}),
    Scene("Everything is Double", "laws of reality", 7.0, "everything_is_double", {}),
    Scene("Mastery", "laws of reality", 7.0, "mastery", {}),
]
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"The Seven Hermetic Principles","scene_count":len(SCENES),
        "runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],
        "continuity_object":"SUBThe Seven Hermetic Principles",
        "palette_roles":{"gold":"mentalism","violet":"correspondence"},"scenes":recs},
