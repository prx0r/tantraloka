...
OUTPUT = Path("/mnt/HC_Volume_106427611/goldrender/output_subtle_body")
...
def v_the_72000_nadis(im, u, t, p):
    ...
    seal(im,"The 72,000 Nadis","nadis, chakras, prana")

def v_sushumna_the_central(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Sushumna The Central Channel","nadis, chakras, prana")

def v_ida_and_pingala(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Ida and Pingala","nadis, chakras, prana")

def v_the_seven_chakras(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"The Seven Chakras","nadis, chakras, prana")

def v_muladhara_the_root(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Muladhara The Root","nadis, chakras, prana")

def v_svadhisthana_the_abo(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Svadhisthana The Abode","nadis, chakras, prana")

def v_manipura_the_city_of(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Manipura The City of Gems","nadis, chakras, prana")

def v_anahata_the_unstruck(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Anahata The Unstruck","nadis, chakras, prana")

def v_vishuddha_the_pure(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Vishuddha The Pure","nadis, chakras, prana")

def v_ajna_the_command(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Ajna The Command","nadis, chakras, prana")

def v_sahasrara_the_thousa(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Sahasrara The Thousand","nadis, chakras, prana")

def v_kundalini_the_coiled(im, u, t, p):
    w,h=im.size; d=ImageDraw.Draw(im); cx,cy=w*0.50,h*0.42; r=ease(u)
    for j in range(int(10*r)):
        a=j*math.tau/10+t*0.2; rr=25+20*math.sin(t*0.3+j)
        x=cx+math.cos(a)*rr; y=cy+math.sin(a)*rr*0.5
        ...
        d.ellipse((x-4,y-4,x+4,y+4),fill=(*PALE_GOLD,int(150*r)),outline=(*GOLD,int(120*r)),width=2)
    glow_circle(im,cx,cy,15,GOLD,int(150*r),12)
    seal(im,"Kundalini The Coiled Power","nadis, chakras, prana")

VISUALS = {
    "the_72000_nadis": v_the_72000_nadis,
    "sushumna_the_central": v_sushumna_the_central,
    "ida_and_pingala": v_ida_and_pingala,
    "the_seven_chakras": v_the_seven_chakras,
    "muladhara_the_root": v_muladhara_the_root,
    "svadhisthana_the_abo": v_svadhisthana_the_abo,
    "manipura_the_city_of": v_manipura_the_city_of,
    "anahata_the_unstruck": v_anahata_the_unstruck,
    "vishuddha_the_pure": v_vishuddha_the_pure,
    "ajna_the_command": v_ajna_the_command,
    "sahasrara_the_thousa": v_sahasrara_the_thousa,
    "kundalini_the_coiled": v_kundalini_the_coiled,
}
...
SCENES = [
    Scene("The 72,000 Nadis", "nadis, chakras, prana", 7.0, "the_72000_nadis", {}),
    Scene("Sushumna The Central Channel", "nadis, chakras, prana", 7.0, "sushumna_the_central", {}),
    Scene("Ida and Pingala", "nadis, chakras, prana", 7.0, "ida_and_pingala", {}),
    Scene("The Seven Chakras", "nadis, chakras, prana", 7.0, "the_seven_chakras", {}),
    Scene("Muladhara The Root", "nadis, chakras, prana", 7.0, "muladhara_the_root", {}),
    Scene("Svadhisthana The Abode", "nadis, chakras, prana", 7.0, "svadhisthana_the_abo", {}),
    Scene("Manipura The City of Gems", "nadis, chakras, prana", 7.0, "manipura_the_city_of", {}),
    Scene("Anahata The Unstruck", "nadis, chakras, prana", 7.0, "anahata_the_unstruck", {}),
    Scene("Vishuddha The Pure", "nadis, chakras, prana", 7.0, "vishuddha_the_pure", {}),
    Scene("Ajna The Command", "nadis, chakras, prana", 7.0, "ajna_the_command", {}),
    Scene("Sahasrara The Thousand", "nadis, chakras, prana", 7.0, "sahasrara_the_thousa", {}),
    Scene("Kundalini The Coiled Power", "nadis, chakras, prana", 7.0, "kundalini_the_coiled", {}),
]
...
def export_timeline():
    ...
    p.write_text(json.dumps({"title":"The Subtle Body","scene_count":len(SCENES),
        "runtime_seconds":round(cursor,3),"shot_duration_range":[5,10],
        "continuity_object":"SUBThe Subtle Body",
        "palette_roles":{"cyan":"nadis","gold":"kundalini","violet":"crown"},"scenes":recs},
